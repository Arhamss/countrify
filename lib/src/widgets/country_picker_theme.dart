...
class CountryPickerTheme {
  ...
  static CountryPickerTheme custom({
    ...
    return CountryPickerTheme(
      ...
      headerIconColor: onSurface.withOpacity(0.7),
      ...
      searchIconColor: onSurface.withOpacity(0.6),
      searchBarBorderColor: onSurface.withOpacity(0.2),
      ...
      filterIconColor: onSurface.withOpacity(0.6),
      countryItemBackgroundColor: bgColor,
      countryItemSelectedColor: baseColor.withOpacity(0.1),
